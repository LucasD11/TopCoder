...
class Literature:
    def expectation(self, n, Teja, history):
...
def do_test(n, Teja, history, __expected):
    ...
    exception = None
    try:
        __result = instance.expectation(n, Teja, history);
    except:
        import traceback
...
def run_tests():
    sys.stdout.write("Literature (500 Points)\n\n")
    ...
    with open("Literature.sample", "r") as f:
        while True:
            label = f.readline()
